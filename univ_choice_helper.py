...
# 대학 정보 데이터프레임
df = pd.DataFrame({
    '대학': ["가톨릭대학교", "경기대학교", "광운대학교", "단국대학교", "서울여대학교", "아주대학교", "연세대학교", "인하대학교"],
    '사진': [
...
# 학교별 학과 매핑 (학교 -> 학과 목록)
school_to_major = {
    "가톨릭대학교": ["영어영문학부", "중국언어문화학과", "일어일본문화학과", "국제학부"],
    "경기대학교": ["글로벌어문학부(독일어, 프랑스어, 일본어, 중국어, 러시아어)", "정치외교학전공"],
    "광운대학교": ["영어산업학과", "동북아문화산업학부", "국제학부", "국제통상학부"],
    "단국대학교": ["영미인문학과", "무역학과", "정치외교학과"],
    "서울여대학교": ["영어영문학과", "중어중문학과", "일어일문학과"],
    "아주대학교": ["자유전공학부", "정치외교학과", "사회학과"],
    "연세대학교": ["정치외교학과", "사회학과", "불어불문학과", "독어독문학과", "영어영문학과", "노어노문학과", "중어중문학과"],
    "인하대학교": ["중국학과", "일본언어문화학과", "영미유럽인문융합학부", "정치외교학과", "국제통상학과"]
}
